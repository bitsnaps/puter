...
>>>>>>> origin/main:src/gui/src/UI/UIWindowLogin.js
...
async function UIWindowLogin(options) {
  ...
  return new Promise(async (resolve) => {
    ...
    // create account link
    if (
      options.show_signup_button === undefined ||
      options.show_signup_button
    ) {
...
<<<<<<< HEAD:src/UI/UIWindowLogin.js
        ...
        let headers = {};
        if (window.custom_headers) headers = window.custom_headers;
...
>>>>>>> origin/main:src/gui/src/UI/UIWindowLogin.js
                ...
                $errorMessage.html(
                  `Failed to log in: Error ${html_encode(err.status)}`,
                );
              }
            }
    ...
    $(el_window)
      ...
      .on("click", async function (e) {
        ...
        if (signup) resolve(true);
      });

    $(el_window)
      .find(`#toggle-show-password-${internal_id}`)
      .on("click", function (e) {
        options.show_password = !options.show_password;
        // hide/show password and update icon
        $(el_window)
          .find(".password")
          .attr("type", options.show_password ? "text" : "password");
        $(el_window)
          .find(".toggle-show-password-icon")
          .attr(
            "src",
            options.show_password
